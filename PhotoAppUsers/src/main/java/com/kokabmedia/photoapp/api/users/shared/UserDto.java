package com.kokabmedia.photoapp.api.users.shared;
 ...
 * 
 * The Serializable interface will  convert its state to a byte stream so that 
 * the byte stream can be reverted back into a copy of the object 
 */
public class UserDto implements Serializable {
	
	private static final long serialVersionUID = -8057909310548140420L;
